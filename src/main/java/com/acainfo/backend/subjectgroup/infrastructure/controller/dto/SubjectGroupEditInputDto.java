...
/**
 * DTO de entrada para la actualización de grupos de asignatura.
 * No permite cambiar la asignatura asociada ni el contador de inscripciones.
 */
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "Datos necesarios para actualizar un grupo de asignatura existente")
public class SubjectGroupEditInputDto {
